...
public class BaiViet {
    ...
    public TrangThaiBaiViet getTrangThai() { return trangThai; }
    public void setTrangThai(TrangThaiBaiViet trangThai) { this.trangThai = trangThai; }
    ...
    public LoaiTacGia getLoaiTacGia() { return loaiTacGia; }
    public void setLoaiTacGia(LoaiTacGia loaiTacGia) { this.loaiTacGia = loaiTacGia; }
