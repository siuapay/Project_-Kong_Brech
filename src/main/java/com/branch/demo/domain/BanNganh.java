...
public class BanNganh {
    ...
    public List<NhanSu> getDanhSachNhanSu() { return danhSachNhanSu; }
    public void setDanhSachNhanSu(List<NhanSu> danhSachNhanSu) { this.danhSachNhanSu = danhSachNhanSu; }
    
    public List<DiemNhom> getDanhSachDiemNhom() { return danhSachDiemNhom; }
    public void setDanhSachDiemNhom(List<DiemNhom> danhSachDiemNhom) { this.danhSachDiemNhom = danhSachDiemNhom; }
    ...
    public String getDienThoaiLienHe() { return dienThoaiLienHe; }
    public void setDienThoaiLienHe(String dienThoaiLienHe) { this.dienThoaiLienHe = dienThoaiLienHe; }
    
    public TrangThaiBanNganh getTrangThai() { return trangThai; }
    public void setTrangThai(TrangThaiBanNganh trangThai) { this.trangThai = trangThai; }
    ...
    public NhanSu getTruongBan() {
        return danhSachNhanSu.stream()
                .filter(ns -> ns.getChucVu() != null && ns.getChucVu().toLowerCase().contains("trưởng"))
                .findFirst()
                .orElse(null);
    }
