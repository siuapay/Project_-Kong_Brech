...
@RestController
@RequestMapping("/api")
public class AdminControllerApiOfLoai {

    @Autowired
    private AdminService adminService;

    @GetMapping(value = "/all-loai-of-su-kien", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<?> getAllLoaiSuKien() {
        try {
            ...
            System.out.println("API /admin/api/all-loai-su-kien called successfully, returning " + loaiSuKienList.size()
                    + " items");
