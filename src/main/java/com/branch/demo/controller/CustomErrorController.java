...
public class CustomErrorController implements ErrorController {
    ...
    public String handleError_DISABLED(HttpServletRequest request, Model model) {
    ...
    // Temporary debug method - remove after fixing the issue
    // @RequestMapping("/error")
    // public String handleErrorDebug(HttpServletRequest request, Model model) {
    //     Object status = request.getAttribute(RequestDispatcher.ERROR_STATUS_CODE);
    //     Object errorMessage = request.getAttribute(RequestDispatcher.ERROR_MESSAGE);
    //     Object requestUri = request.getAttribute(RequestDispatcher.ERROR_REQUEST_URI);
    //     Object exception = request.getAttribute(RequestDispatcher.ERROR_EXCEPTION);
    ...
    //     // Return a simple debug page instead of the fancy error page
    //     model.addAttribute("status", status);
    //     model.addAttribute("errorMessage", errorMessage);
    //     model.addAttribute("requestUri", requestUri);
    //     model.addAttribute("exception", exception);

    //     return "error/debug"; // We'll create this simple template
    // }
}